...
(function() {
  ...
  checkAndReportState = function() {
    ...
    // Check if selection or elements changed
    const currentSelectedIds = selectedIds.join(',');

    // Create a simple hash of selected elements to detect changes
    let elementsHash = '';
    ...
    if (currentSelectedIds !== lastSelectedIds || elementsHash !== lastElementsHash) {
      lastSelectedIds = currentSelectedIds;
  ...
  canvases.forEach(canvas => {
    ...
    // Track during dragging for smoother updates
